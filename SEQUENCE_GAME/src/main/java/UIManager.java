...
public class UIManager extends GameObject {
    ...
    private void setupLeftUI() {
        ...
        debugModeCheckbox = new CheckBox.Builder()
                ...
                .onChecked(this::debugModeChecked)
                .onUnchecked(this::debugModeUnchecked)
    ...
    private void debugModeChecked() {
        if (logicManager != null) {
            logicManager.onDebugModeChanged(true);
        }
    }
    private void debugModeUnchecked() {
        if (logicManager != null) {
            logicManager.onDebugModeChanged(false);
        }
    }
    //Getter/Setter
